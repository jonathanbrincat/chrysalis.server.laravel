...
class DashboardController extends Controller {
  ...
  public function index() {
    ...
    return view('pages.dashboard')->with('posts', $user->posts); //returned with the relationship '->posts' expressed in the model(which will grant access to the returns of that relationship - query made behind the scenes)
